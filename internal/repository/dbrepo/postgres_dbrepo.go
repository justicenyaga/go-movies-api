...
func (m *PostgresDBRepo) InsertMovie(movie models.Movie) (int, error) {
	...
	stmt := `insert into movies (title, description, runtime, release_date,
...
func (m *PostgresDBRepo) UpdateMovie(movie models.Movie) error {
	...
	stmt := `update movies set title = $1, release_date = $2, runtime = $3,
    mpaa_rating = $4, description = $5, image = $6, updated_at = $7
    where id = $8`
